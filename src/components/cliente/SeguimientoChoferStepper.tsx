...
export interface SeguimientoChoferStepperProps {
  ...
  guiaEstado?: string
  title?: string
  onStepClick?: (value: SeguimientoChoferValue) => void  // solo chofer
}
    ...
    <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
      ...
      <div className="flex w-full min-w-0 items-center">
        {STEPS.map((step, i) => {
          ...
          const circle = (
            <div
              className={`flex size-9 items-center justify-center rounded-full sm:size-10 transition-transform ${
                isActive
